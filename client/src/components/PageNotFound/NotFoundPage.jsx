...
const NotFoundPage = () => {
  return (
    <>
      <Navbar />
      <div className="background mt-32 overflow-hidden ">
        <div className="ground"></div>
      </div>
      <div className="containesr  flex md:flex-row flex-col">
        <div className="left-section content-center">
        ...
        <div className="right-section   h-full relative">
          <svg
            className="svgimg absolute bottom-0 h-full"
